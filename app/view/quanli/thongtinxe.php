...
if (isset($_POST['search_value'])) {
    $result = quanli_controller::search_xe_by_tenxe($_POST['search_value']);
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="container">
    <div class="row">
        <div >
            <h3 class="text-center mb-3" >Tìm xe</h3>
            <form action="#" method="POST">
                <input type="text" name="search_value" class="form-control" placeholder="Nhập tên xe">
