...
<nav id="navbar" class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            <li><a id="classroom" href="/index.php?controller=banhang&action=index">Danh sách đơn hàng</a></li>
        </ul>

        <ul class="nav navbar-nav">
            <li><a id="classroom" href="/index.php?controller=banhang&action=list_car_info" style="color: rosybrown">Danh sách xe</a></li>
        </ul>
...
<div id="responsive_table">
    <table id="table_list">
        ...
        <tr class="control1">
            <td colspan="4">
                <a class="btn btn-success px-5 mr-2 btn-lg" href="/index.php?controller=banhang&action=add_order" >Thêm đơn hàng</a>
            </td>
        </tr>
        <tr class="header">
            <td>Mã đơn hàng</td>
        ...
        foreach ($data as $row) {
            ...
            <tr class="item">
                ...
                <?php
                    ...
                    ?>
                        <td>
                            <a href="/index.php?controller=banhang&action=add_order&maDH=<?= $maDH; ?>" class="edit">Sửa</a>
                        </td>
                <?php
                        }
                    }
